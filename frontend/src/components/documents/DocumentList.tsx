        ...
        >
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              {doc.extracted_metadata?.document_type && (
                <DocTypeBadge type={doc.extracted_metadata.document_type} />
              )}
            </div>
            ...
            {doc.extracted_metadata?.keywords && doc.extracted_metadata.keywords.length > 0 && (
              <div className="flex flex-wrap gap-1 mt-1.5">
                {doc.extracted_metadata.keywords.map((kw, i) => (
                  <span
                    key={i}
